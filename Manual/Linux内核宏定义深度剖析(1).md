...
![GitHub](https://github.com/bandianxuediao/MacroDefinitionInTheLinuxKernel/blob/master/Photo/LinuxKernel-1-1.JPG)
...
　　`对上面预期结果有疑问的可以查阅。。。`</br>
   实际运行结果如下：</br>
![](http://pcnwqhy39.bkt.clouddn.com/LinuxKernel-1-7.JPG)</br>
